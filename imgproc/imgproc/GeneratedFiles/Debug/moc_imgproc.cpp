...
static const char qt_meta_stringdata_imgproc[] = {
    "imgproc\0\0on_imageLabel_imageShow()\0"
};
...
void imgproc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_imageLabel_imageShow(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData imgproc::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject imgproc::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_imgproc,
      qt_meta_data_imgproc, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &imgproc::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_imgproc))
